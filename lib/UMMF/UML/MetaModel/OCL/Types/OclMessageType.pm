...
package UMMF::UML::MetaModel::OCL::Types::OclMessageType;
...
=head2 C<1> : C<> ----E<gt>  C<referredOperation> : UMMF::UML::MetaModel::Foundation::Core::Operation C<0..1>
...
=head2 C<1> : C<> ----E<gt>  C<referredSignal> : UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal C<0..1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::OCL::Types::OclMessageType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::OCL::Types::OclMessageType|UMMF::UML::MetaModel::OCL::Types::OclMessageType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::OCL::Types::OclMessageType')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::OCL::Types::OclMessageType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::OCL::Types::OclMessageType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::OCL::Types::OclMessageType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::OCL::Types::OclMessageType|UMMF::UML::MetaModel::OCL::Types::OclMessageType>.
...
sub ___initialize
{
  ...
  #   1
  #  <--> 
  #  referredOperation 0..1 UMMF::UML::MetaModel::Foundation::Core::Operation.
  ...
  #   1
  #  <--> 
  #  referredSignal 0..1 UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::OCL::Types::OclMessageType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::OCL::Types::OclMessageType::___create(@args);
...
Returns the AssociationEnd C<referredOperation> value of type L<UMMF::UML::MetaModel::Foundation::Core::Operation|UMMF::UML::MetaModel::Foundation::Core::Operation>.
...
sub set_referredOperation ($$)
{
  ...
  if ( ($old = $self->{'referredOperation'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Foundation::Core::Operation')->__typecheck($val, "UMMF::UML::MetaModel::OCL::Types::OclMessageType.referredOperation") }
...
sub add_referredOperation ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'referredOperation'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Foundation::Core::Operation')->__typecheck($val, "UMMF::UML::MetaModel::OCL::Types::OclMessageType.referredOperation");
      
    # confess("UMMF::UML::MetaModel::OCL::Types::OclMessageType::referredOperation: too many")
    # if defined $self->{'referredOperation'};
...
Clears the AssociationEnd C<referredOperation> links to L<UMMF::UML::MetaModel::Foundation::Core::Operation|UMMF::UML::MetaModel::Foundation::Core::Operation>.
Returns C<$obj>.
...
Returns the number of elements of type L<UMMF::UML::MetaModel::Foundation::Core::Operation|UMMF::UML::MetaModel::Foundation::Core::Operation> associated with C<referredOperation>.
...
Returns the AssociationEnd C<referredSignal> value of type L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal>.
...
sub set_referredSignal ($$)
{
  ...
  if ( ($old = $self->{'referredSignal'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal')->__typecheck($val, "UMMF::UML::MetaModel::OCL::Types::OclMessageType.referredSignal") }
...
sub add_referredSignal ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'referredSignal'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal')->__typecheck($val, "UMMF::UML::MetaModel::OCL::Types::OclMessageType.referredSignal");
      
    # confess("UMMF::UML::MetaModel::OCL::Types::OclMessageType::referredSignal: too many")
    # if defined $self->{'referredSignal'};
...
Clears the AssociationEnd C<referredSignal> links to L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal>.
Returns C<$obj>.
...
Returns the number of elements of type L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal> associated with C<referredSignal>.
