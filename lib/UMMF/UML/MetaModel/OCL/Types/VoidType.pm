...
package UMMF::UML::MetaModel::OCL::Types::VoidType;
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::OCL::Types::VoidType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::OCL::Types::VoidType|UMMF::UML::MetaModel::OCL::Types::VoidType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::OCL::Types::VoidType')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::OCL::Types::VoidType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::OCL::Types::VoidType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::OCL::Types::VoidType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::OCL::Types::VoidType|UMMF::UML::MetaModel::OCL::Types::VoidType>.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::OCL::Types::VoidType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::OCL::Types::VoidType::___create(@args);
