...
package UMMF::UML::MetaModel::OCL::Types::TupleType;
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::OCL::Types::TupleType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::OCL::Types::TupleType|UMMF::UML::MetaModel::OCL::Types::TupleType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::OCL::Types::TupleType')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::OCL::Types::TupleType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::OCL::Types::TupleType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::OCL::Types::TupleType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::OCL::Types::TupleType|UMMF::UML::MetaModel::OCL::Types::TupleType>.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::OCL::Types::TupleType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::OCL::Types::TupleType::___create(@args);
