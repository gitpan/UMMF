...
package UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp;
...
=head2 C<0..1> : C<parentOperation> E<lt>---E<gt>  C<arguments> : UMMF::UML::MetaModel::OCL::Expressions::OclExpression C<0..*>
...
=head2 C<0..*> : C<> ----E<gt>  C<referredOperation> : UMMF::UML::MetaModel::Foundation::Core::Operation C<1>
...
Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp|UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp')  ;
}
...
Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp|UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp>.
...
sub ___initialize
{
  ...
  #  parentOperation 0..1
  #  <--> 
  #  arguments 0..* UMMF::UML::MetaModel::OCL::Expressions::OclExpression.
  ...
  #   0..*
  #  <--> 
  #  referredOperation 1 UMMF::UML::MetaModel::Foundation::Core::Operation.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp::___create(@args);
...
Returns the AssociationEnd C<arguments> values of type L<UMMF::UML::MetaModel::OCL::Expressions::OclExpression|UMMF::UML::MetaModel::OCL::Expressions::OclExpression>.
...
sub add_arguments ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML::MetaModel::OCL::Expressions::OclExpression')->__typecheck($val, "UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp.arguments");
...
Clears the AssociationEnd C<arguments> links to L<UMMF::UML::MetaModel::OCL::Expressions::OclExpression|UMMF::UML::MetaModel::OCL::Expressions::OclExpression>.
Returns C<$obj>.
...
sub set_referredOperation ($$)
{
  ...
  if ( ($old = $self->{'referredOperation'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Foundation::Core::Operation')->__typecheck($val, "UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp.referredOperation") }
...
sub add_referredOperation ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'referredOperation'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Foundation::Core::Operation')->__typecheck($val, "UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp.referredOperation");
      
    # confess("UMMF::UML::MetaModel::OCL::Expressions::OperationCallExp::referredOperation: too many")
    # if defined $self->{'referredOperation'};
