...
package UMMF::UML::MetaModel::OCL::Expressions::CallAction;
...
L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::CallOperationAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::CallOperationAction>
...
=head2 C<1> : C<calledOperation> E<lt>----  C<> : UMMF::UML::MetaModel::OCL::Expressions::OclMessageExp C<1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::OCL::Expressions::CallAction->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::OCL::Expressions::CallAction|UMMF::UML::MetaModel::OCL::Expressions::CallAction>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::OCL::Expressions::CallAction')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::OCL::Expressions::CallAction->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::OCL::Expressions::CallAction->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::OCL::Expressions::CallAction' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::OCL::Expressions::CallAction|UMMF::UML::MetaModel::OCL::Expressions::CallAction>.
  ...
  $__tangram_schema ||=
  {
   ...
   [
	 ...
	 # Associations
       ...
       'bases' => [  'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::CallOperationAction',  ],
       'sql' => {
...
sub __initialize
{
  ...
  unless ( ! $__initialize_use ) {
    ...
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::CallOperationAction');
  }

  $self->UMMF::UML::MetaModel::OCL::Expressions::CallAction::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::OCL::Expressions::CallAction::___create(@args);
  ...
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::CallOperationAction::___create();
