...
package UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp;
...
=head2 C<stringSymbol> : UMMF::UML::MetaModel::Foundation::Data_Types::String 
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp|UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaStringLiteralExp>


Returns true if receiver is a L<UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp|UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp>.
Other receivers will return false.

=cut
sub isaStringLiteralExp { 1 }


=head2 C<isaOCL__Expressions__StringLiteralExp>


Returns true if receiver is a L<UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp|UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp>.
Other receivers will return false.
This is the fully qualified version of the C<isaStringLiteralExp> method.

=cut
sub isaOCL__Expressions__StringLiteralExp { 1 }
...
Returns the UML Model name (C<'OCL::Expressions::StringLiteralExp'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'OCL::Expressions::StringLiteralExp' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp' =>
     {
       'table' => 'OCL__Expressions__StringLiteralExp',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub ___initialize
{
  ...
  if ( exists $self->{'stringSymbol'} ) {
    my $x = $self->{'stringSymbol'};
    $self->{'stringSymbol'} = undef;
    $self->set_stringSymbol($x);
  } else {
      }
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::OCL::Expressions::StringLiteralExp::___create(@args);
...
=head2 C<stringSymbol>

  my $val = $obj->stringSymbol;

Returns the L<UMMF::UML::MetaModel::Foundation::Data_Types::String|UMMF::UML::MetaModel::Foundation::Data_Types::String> value of Attribute C<stringSymbol>.
...
=head2 C<set_stringSymbol>

  $obj->set_stringSymbol($val);

Sets the value of Attribute C<stringSymbol>.
...
=head2 C<count_stringSymbol>

  $obj->count_stringSymbol;

Returns the number of elements (0 or 1) in C<stringSymbol>.

=cut
sub count_stringSymbol ($)
{
  my ($self) = @_;
