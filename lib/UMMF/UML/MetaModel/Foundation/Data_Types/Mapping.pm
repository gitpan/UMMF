...
package UMMF::UML::MetaModel::Foundation::Data_Types::Mapping;
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Foundation::Data_Types::Mapping->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Foundation::Data_Types::Mapping|UMMF::UML::MetaModel::Foundation::Data_Types::Mapping>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Foundation::Data_Types::Mapping')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Foundation::Data_Types::Mapping->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Foundation::Data_Types::Mapping->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Foundation::Data_Types::Mapping' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Data_Types::Mapping|UMMF::UML::MetaModel::Foundation::Data_Types::Mapping>.
...
=head2 C<isaFoundation__Data_Types__Mapping>


Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Data_Types::Mapping|UMMF::UML::MetaModel::Foundation::Data_Types::Mapping>.
Other receivers will return false.
This is the fully qualified version of the C<isaMapping> method.

=cut
sub isaFoundation__Data_Types__Mapping { 1 }
...
Returns the UML Model name (C<'Foundation::Data_Types::Mapping'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Foundation::Data_Types::Mapping' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Foundation::Data_Types::Mapping' =>
     {
       'table' => 'Foundation__Data_Types__Mapping',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Foundation::Data_Types::Mapping::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Foundation::Data_Types::Mapping::___create(@args);
