...
package UMMF::UML::MetaModel::Foundation::Data_Types::Expression;
...
=head2 C<0..*> : C<expression> E<lt>---E<gt>  C<procedure> : UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Procedure C<0..1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Foundation::Data_Types::Expression->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Foundation::Data_Types::Expression|UMMF::UML::MetaModel::Foundation::Data_Types::Expression>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Foundation::Data_Types::Expression')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Foundation::Data_Types::Expression->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Foundation::Data_Types::Expression->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Foundation::Data_Types::Expression' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Data_Types::Expression|UMMF::UML::MetaModel::Foundation::Data_Types::Expression>.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Foundation::Data_Types::Expression::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Foundation::Data_Types::Expression::___create(@args);
...
sub set_procedure ($$)
{
  ...
  if ( ($old = $self->{'procedure'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Procedure')->__typecheck($val, "UMMF::UML::MetaModel::Foundation::Data_Types::Expression.procedure") }
...
sub add_procedure ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'procedure'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Procedure')->__typecheck($val, "UMMF::UML::MetaModel::Foundation::Data_Types::Expression.procedure");
      
    # confess("UMMF::UML::MetaModel::Foundation::Data_Types::Expression::procedure: too many")
    # if defined $self->{'procedure'};
