...
package UMMF::UML::MetaModel::Foundation::Core::DataType;
...
=head2 C<1> : C<type> E<lt>----  C<> : UMMF::UML::MetaModel::Behavioral_Elements::Actions::Computation_Actions::ArgumentSpecification C<0..*>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Foundation::Core::DataType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Foundation::Core::DataType|UMMF::UML::MetaModel::Foundation::Core::DataType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Foundation::Core::DataType')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Foundation::Core::DataType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Foundation::Core::DataType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Foundation::Core::DataType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Core::DataType|UMMF::UML::MetaModel::Foundation::Core::DataType>.
...
=head2 C<isaFoundation__Core__DataType>
...
=cut
sub isaFoundation__Core__DataType { 1 }
...
Returns the UML Model name (C<'Foundation::Core::DataType'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Foundation::Core::DataType' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Foundation::Core::DataType' =>
     {
       'table' => 'Foundation__Core__DataType',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Foundation::Core::DataType::___create(@args);
