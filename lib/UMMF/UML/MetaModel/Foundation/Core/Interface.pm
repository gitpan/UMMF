...
package UMMF::UML::MetaModel::Foundation::Core::Interface;
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Foundation::Core::Interface->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Foundation::Core::Interface|UMMF::UML::MetaModel::Foundation::Core::Interface>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Foundation::Core::Interface')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Foundation::Core::Interface->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Foundation::Core::Interface->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Foundation::Core::Interface' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaInterface>


Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Core::Interface|UMMF::UML::MetaModel::Foundation::Core::Interface>.
...
=head2 C<isaFoundation__Core__Interface>


Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Core::Interface|UMMF::UML::MetaModel::Foundation::Core::Interface>.
Other receivers will return false.
This is the fully qualified version of the C<isaInterface> method.

=cut
sub isaFoundation__Core__Interface { 1 }
...
Returns the UML Model name (C<'Foundation::Core::Interface'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Foundation::Core::Interface' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Foundation::Core::Interface' =>
     {
       'table' => 'Foundation__Core__Interface',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Foundation::Core::Interface::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Foundation::Core::Interface::___create(@args);
