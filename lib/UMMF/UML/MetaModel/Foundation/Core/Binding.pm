...
package UMMF::UML::MetaModel::Foundation::Core::Binding;
...
=head2 C<1> : C<binding> E<lt>---E<gt>  C<argument> : UMMF::UML::MetaModel::Foundation::Core::TemplateArgument C<1..*>
...
Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Foundation::Core::Binding|UMMF::UML::MetaModel::Foundation::Core::Binding>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Foundation::Core::Binding')  ;
}
...
Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Foundation::Core::Binding->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Foundation::Core::Binding' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Core::Binding|UMMF::UML::MetaModel::Foundation::Core::Binding>.
...
sub ___initialize
{
  ...
  #  binding 1
  #  <--> 
  #  argument 1..* UMMF::UML::MetaModel::Foundation::Core::TemplateArgument.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Foundation::Core::Binding::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Foundation::Core::Binding::___create(@args);
...
Returns the AssociationEnd C<argument> values of type L<UMMF::UML::MetaModel::Foundation::Core::TemplateArgument|UMMF::UML::MetaModel::Foundation::Core::TemplateArgument>.
...
sub add_argument ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML::MetaModel::Foundation::Core::TemplateArgument')->__typecheck($val, "UMMF::UML::MetaModel::Foundation::Core::Binding.argument");
...
Clears the AssociationEnd C<argument> links to L<UMMF::UML::MetaModel::Foundation::Core::TemplateArgument|UMMF::UML::MetaModel::Foundation::Core::TemplateArgument>.
Returns C<$obj>.
