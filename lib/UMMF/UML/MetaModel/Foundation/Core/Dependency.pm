...
package UMMF::UML::MetaModel::Foundation::Core::Dependency;
...
=head2 C<0..*> : C<clientDependency> E<lt>---E<gt>  C<client> : UMMF::UML::MetaModel::Foundation::Core::ModelElement C<1..*>
...
=head2 C<0..*> : C<supplierDependency> E<lt>---E<gt>  C<supplier> : UMMF::UML::MetaModel::Foundation::Core::ModelElement C<1..*>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Foundation::Core::Dependency->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Foundation::Core::Dependency|UMMF::UML::MetaModel::Foundation::Core::Dependency>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Foundation::Core::Dependency')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Foundation::Core::Dependency->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Foundation::Core::Dependency->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Foundation::Core::Dependency' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Core::Dependency|UMMF::UML::MetaModel::Foundation::Core::Dependency>.
...
sub ___initialize
{
  ...
  #  clientDependency 0..*
  #  <--> 
  #  client 1..* UMMF::UML::MetaModel::Foundation::Core::ModelElement.
  ...
  #  <--> 
  #  supplier 1..* UMMF::UML::MetaModel::Foundation::Core::ModelElement.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Foundation::Core::Dependency::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Foundation::Core::Dependency::___create(@args);
...
Returns the AssociationEnd C<client> values of type L<UMMF::UML::MetaModel::Foundation::Core::ModelElement|UMMF::UML::MetaModel::Foundation::Core::ModelElement>.
...
sub add_client ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML::MetaModel::Foundation::Core::ModelElement')->__typecheck($val, "UMMF::UML::MetaModel::Foundation::Core::Dependency.client");
...
Clears the AssociationEnd C<client> links to L<UMMF::UML::MetaModel::Foundation::Core::ModelElement|UMMF::UML::MetaModel::Foundation::Core::ModelElement>.
Returns C<$obj>.
...
Returns the AssociationEnd C<supplier> values of type L<UMMF::UML::MetaModel::Foundation::Core::ModelElement|UMMF::UML::MetaModel::Foundation::Core::ModelElement>.
In array context, returns all the objects in the Association.
In scalar context, returns an array ref of all the objects in the Association.
...
sub add_supplier ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        next if $x->includes($val);
        $self->__use('UMMF::UML::MetaModel::Foundation::Core::ModelElement')->__typecheck($val, "UMMF::UML::MetaModel::Foundation::Core::Dependency.supplier");
...
Clears the AssociationEnd C<supplier> links to L<UMMF::UML::MetaModel::Foundation::Core::ModelElement|UMMF::UML::MetaModel::Foundation::Core::ModelElement>.
Returns C<$obj>.
