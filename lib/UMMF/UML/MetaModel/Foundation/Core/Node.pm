...
package UMMF::UML::MetaModel::Foundation::Core::Node;
...
=head2 C<0..*> : C<deploymentLocation> E<lt>---E<gt>  C<deployedComponent> : UMMF::UML::MetaModel::Foundation::Core::Component C<0..*>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Foundation::Core::Node->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Foundation::Core::Node|UMMF::UML::MetaModel::Foundation::Core::Node>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Foundation::Core::Node')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Foundation::Core::Node->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Foundation::Core::Node->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Foundation::Core::Node' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Core::Node|UMMF::UML::MetaModel::Foundation::Core::Node>.
...
sub ___initialize
{
  ...
  #  <--> 
  #  deployedComponent 0..* UMMF::UML::MetaModel::Foundation::Core::Component.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Foundation::Core::Node::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Foundation::Core::Node::___create(@args);
...
Returns the AssociationEnd C<deployedComponent> values of type L<UMMF::UML::MetaModel::Foundation::Core::Component|UMMF::UML::MetaModel::Foundation::Core::Component>.
...
sub add_deployedComponent ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML::MetaModel::Foundation::Core::Component')->__typecheck($val, "UMMF::UML::MetaModel::Foundation::Core::Node.deployedComponent");
...
Clears the AssociationEnd C<deployedComponent> links to L<UMMF::UML::MetaModel::Foundation::Core::Component|UMMF::UML::MetaModel::Foundation::Core::Component>.
Returns C<$obj>.
