...
package UMMF::UML::MetaModel::Foundation::Core::AssociationClass;
...
=head2 C<1> : C<referredAssociationClass> E<lt>----  C<> : UMMF::UML::MetaModel::OCL::Expressions::AssociationClassEndCallExp C<0..*>
...
=item type = L<UMMF::UML::MetaModel::OCL::Expressions::AssociationClassEndCallExp|UMMF::UML::MetaModel::OCL::Expressions::AssociationClassEndCallExp>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Foundation::Core::AssociationClass->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Foundation::Core::AssociationClass|UMMF::UML::MetaModel::Foundation::Core::AssociationClass>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Foundation::Core::AssociationClass')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Foundation::Core::AssociationClass->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Foundation::Core::AssociationClass->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Foundation::Core::AssociationClass' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaAssociationClass>


Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Core::AssociationClass|UMMF::UML::MetaModel::Foundation::Core::AssociationClass>.
Other receivers will return false.

=cut
sub isaAssociationClass { 1 }


=head2 C<isaFoundation__Core__AssociationClass>


Returns true if receiver is a L<UMMF::UML::MetaModel::Foundation::Core::AssociationClass|UMMF::UML::MetaModel::Foundation::Core::AssociationClass>.
Other receivers will return false.
This is the fully qualified version of the C<isaAssociationClass> method.

=cut
sub isaFoundation__Core__AssociationClass { 1 }
...
Returns the UML Model name (C<'Foundation::Core::AssociationClass'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Foundation::Core::AssociationClass' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Foundation::Core::AssociationClass' =>
     {
       'table' => 'Foundation__Core__AssociationClass',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
