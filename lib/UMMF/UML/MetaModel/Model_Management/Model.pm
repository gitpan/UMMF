...
package UMMF::UML::MetaModel::Model_Management::Model;
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Model_Management::Model->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Model_Management::Model|UMMF::UML::MetaModel::Model_Management::Model>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Model_Management::Model')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Model_Management::Model->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Model_Management::Model->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Model_Management::Model' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Model_Management::Model|UMMF::UML::MetaModel::Model_Management::Model>.
...
=head2 C<isaModel_Management__Model>


Returns true if receiver is a L<UMMF::UML::MetaModel::Model_Management::Model|UMMF::UML::MetaModel::Model_Management::Model>.
Other receivers will return false.
This is the fully qualified version of the C<isaModel> method.

=cut
sub isaModel_Management__Model { 1 }
...
Returns the UML Model name (C<'Model_Management::Model'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Model_Management::Model' }
  ...
  $__tangram_schema ||=
  {
   ...
   [
	 ...
	 # Associations
       ...
       'bases' => [  'UMMF::UML::MetaModel::Model_Management::Package',  ],
       'sql' => {
