...
package UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception;
...
=head2 C<specification> : UMMF::UML::MetaModel::Foundation::Data_Types::String 
...
=head2 C<0..*> : C<reception> E<lt>---E<gt>  C<signal> : UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal C<1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception>.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception::___create(@args);
...
Returns the L<UMMF::UML::MetaModel::Foundation::Data_Types::String|UMMF::UML::MetaModel::Foundation::Data_Types::String> value of Attribute C<specification>.
...
sub set_signal ($$)
{
  ...
  if ( ($old = $self->{'signal'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception.signal") }
...
sub add_signal ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'signal'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception.signal");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Reception::signal: too many")
    # if defined $self->{'signal'};
