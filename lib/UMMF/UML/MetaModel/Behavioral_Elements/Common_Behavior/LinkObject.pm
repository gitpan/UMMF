...
package UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject;
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaLinkObject>


Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject>.
...
=head2 C<isaBehavioral_Elements__Common_Behavior__LinkObject>


Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject>.
Other receivers will return false.
This is the fully qualified version of the C<isaLinkObject> method.

=cut
sub isaBehavioral_Elements__Common_Behavior__LinkObject { 1 }
...
Returns the UML Model name (C<'Behavioral_Elements::Common_Behavior::LinkObject'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Behavioral_Elements::Common_Behavior::LinkObject' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::LinkObject' =>
     {
       'table' => 'Behavioral_Elements__Common_Behavior__LinkObject',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
