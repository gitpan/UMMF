...
package UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet;
...
=head2 C<0..*> : C<interactionInstance> E<lt>---E<gt>  C<context> : UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet C<1>
...
=head2 C<0..*> : C<interactionInstanceSet> E<lt>---E<gt>  C<interaction> : UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::Interaction C<0..1>
...
=head2 C<0..*> : C<interactionInstanceSet> E<lt>---E<gt>  C<particpatingStimulus> : UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Stimulus C<1..*>
...
Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet|UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet')  ;
}
...
Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet|UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet>.
...
sub ___initialize
{
  ...
  #  <--> 
  #  context 1 UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet.
  ...
  #  <--> 
  #  interaction 0..1 UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::Interaction.
  ...
  #  interactionInstanceSet 0..*
  #  <--> 
  #  particpatingStimulus 1..* UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Stimulus.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet::___create(@args);
...
Returns the AssociationEnd C<context> value of type L<UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet|UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet>.
...
C<$val> must of type L<UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet|UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet>.
Returns C<$obj>.
...
sub set_context ($$)
{
  ...
  if ( ($old = $self->{'context'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet.context") }
...
sub add_context ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'context'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet.context");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet::context: too many")
    # if defined $self->{'context'};
...
Clears the AssociationEnd C<context> links to L<UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet|UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet>.
Returns C<$obj>.
...
Returns the number of elements of type L<UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet|UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::CollaborationInstanceSet> associated with C<context>.
...
sub set_interaction ($$)
{
  ...
  if ( ($old = $self->{'interaction'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::Interaction')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet.interaction") }
...
sub add_interaction ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'interaction'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::Interaction')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet.interaction");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet::interaction: too many")
    # if defined $self->{'interaction'};
...
Returns the AssociationEnd C<particpatingStimulus> values of type L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Stimulus|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Stimulus>.
...
sub add_particpatingStimulus ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Stimulus')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Collaborations::InteractionInstanceSet.particpatingStimulus");
...
Clears the AssociationEnd C<particpatingStimulus> links to L<UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Stimulus|UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Stimulus>.
Returns C<$obj>.
