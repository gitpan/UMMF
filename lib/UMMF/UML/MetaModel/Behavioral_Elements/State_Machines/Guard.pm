...
package UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard;
...
=head2 C<expression> : UMMF::UML::MetaModel::Foundation::Data_Types::BooleanExpression 
...
=head2 C<0..1> : C<guard> E<lt>---E<gt>  C<transition> : UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Transition C<1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard|UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard|UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard>.
...
sub ___initialize
{
  ...
  #  guard 0..1
  #  <--> 
  #  transition 1 UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Transition.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard::___create(@args);
...
Returns the L<UMMF::UML::MetaModel::Foundation::Data_Types::BooleanExpression|UMMF::UML::MetaModel::Foundation::Data_Types::BooleanExpression> value of Attribute C<expression>.
...
sub set_expression ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::UML::MetaModel::Foundation::Data_Types::BooleanExpression')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard.expression");
  }
...
sub set_transition ($$)
{
  ...
  if ( ($old = $self->{'transition'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Transition')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard.transition") }
...
sub add_transition ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'transition'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Transition')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard.transition");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::State_Machines::Guard::transition: too many")
    # if defined $self->{'transition'};
