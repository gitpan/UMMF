...
package UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor;
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor>.
...
=head2 C<isaBehavioral_Elements__Use_Cases__Actor>


Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor>.
Other receivers will return false.
This is the fully qualified version of the C<isaActor> method.

=cut
sub isaBehavioral_Elements__Use_Cases__Actor { 1 }
...
Returns the UML Model name (C<'Behavioral_Elements::Use_Cases::Actor'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Behavioral_Elements::Use_Cases::Actor' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor' =>
     {
       'table' => 'Behavioral_Elements__Use_Cases__Actor',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Actor::___create(@args);
