...
package UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase;
...
=head2 C<1> : C<base> E<lt>---E<gt>  C<extend> : UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend C<0..*>
...
=head2 C<1> : C<extension> E<lt>---E<gt>  C<extended> : UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend C<0..*>
...
=head2 C<1> : C<useCase> E<lt>---E<gt>  C<extensionPoint> : UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::ExtensionPoint C<0..*>
...
=head2 C<1> : C<base> E<lt>---E<gt>  C<include> : UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include C<0..*>
...
=item type = L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase>.
...
sub ___initialize
{
  ...
  #  extension 1
  #  <--> 
  #  extended 0..* UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend.
  ...
  #  useCase 1
  #  <--> 
  #  extensionPoint 0..* UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::ExtensionPoint.
  ...
  #  base 1
  #  <--> 
  #  include 0..* UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase::___create(@args);
...
sub add_extend ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase.extend");
...
Returns the AssociationEnd C<extended> values of type L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend>.
In array context, returns all the objects in the Association.
In scalar context, returns an array ref of all the objects in the Association.
...
sub add_extended ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        next if $x->includes($val);
        $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase.extended");
...
Clears the AssociationEnd C<extended> links to L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Extend>.
Returns C<$obj>.
...
sub add_extensionPoint ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        next if $x->includes($val);
        $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::ExtensionPoint')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase.extensionPoint");
...
Returns the AssociationEnd C<include> values of type L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include>.
In array context, returns all the objects in the Association.
In scalar context, returns an array ref of all the objects in the Association.
...
sub add_include ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        next if $x->includes($val);
        $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::UseCase.include");
...
Clears the AssociationEnd C<include> links to L<UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include|UMMF::UML::MetaModel::Behavioral_Elements::Use_Cases::Include>.
Returns C<$obj>.
