...
package UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable;
...
=head2 C<0..*> : C<variable> E<lt>---E<gt>  C<scope> : UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction C<1>
...
=head2 C<0..*> : C<> ----E<gt>  C<type> : UMMF::UML::MetaModel::Foundation::Core::Classifier C<0..1>
...
=head2 C<1> : C<variable> E<lt>----  C<> : UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Variable_Actions::VariableAction C<0..*>
...
=item type = L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Variable_Actions::VariableAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Variable_Actions::VariableAction>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable>.
...
=head2 C<isaBehavioral_Elements__Actions__Action_Foundation__Variable>


Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable>.
Other receivers will return false.
This is the fully qualified version of the C<isaVariable> method.

=cut
sub isaBehavioral_Elements__Actions__Action_Foundation__Variable { 1 }
...
Returns the UML Model name (C<'Behavioral_Elements::Actions::Action_Foundation::Variable'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Behavioral_Elements::Actions::Action_Foundation::Variable' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable' =>
     {
       'table' => 'Behavioral_Elements__Actions__Action_Foundation__Variable',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub ___initialize
{
  ...
  #  variable 0..*
  #  <--> 
  #  scope 1 UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction.
  ...
  #   0..*
  #  <--> 
  #  type 0..1 UMMF::UML::MetaModel::Foundation::Core::Classifier.
...
sub __initialize
{
  ...
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable::___create(@args);
...
sub set_multiplicity ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::UML::MetaModel::Foundation::Data_Types::Multiplicity')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable.multiplicity");
  }
...
sub set_ordering ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::UML::MetaModel::Foundation::Data_Types::OrderingKind')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable.ordering");
  }
...
Returns the AssociationEnd C<scope> value of type L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction>.
...
Sets the AssociationEnd C<scope> value.
...
sub set_scope ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'scope'}) ne $val ) { # Recursion lock

    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable.scope") }
    ...
    $old->remove_variable($self) if $old;
    $val->add_variable($self)    if $val;
...
Adds the AssociationEnd C<scope> value.
C<$val> must of type L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction>.
...
sub add_scope ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'scope'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable.scope");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable::scope: too many")
    # if defined $self->{'scope'};
...
=head2 C<remove_scope>

  $obj->remove_scope($val);

Removes the AssociationEnd C<scope> value C<$val>.
Returns C<$obj>.
...
sub remove_scope ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'scope'}) eq $val ) { # Recursion lock
    $val = $self->{'scope'} = undef;         # Recursion lock
...
Clears the AssociationEnd C<scope> links to L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction>.
Returns C<$obj>.
...
sub clear_scope ($@)
{
  ...
  my $old;
  if ( defined ($old = $self->{'scope'}) ) { # Recursion lock
    my $val = $self->{'scope'} = undef;      # Recursion lock
...
Returns the number of elements of type L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Composite_Actions::GroupAction> associated with C<scope>.
...
sub set_type ($$)
{
  ...
  if ( ($old = $self->{'type'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Foundation::Core::Classifier')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable.type") }
...
sub add_type ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'type'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Foundation::Core::Classifier')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable.type");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Variable::type: too many")
    # if defined $self->{'type'};
