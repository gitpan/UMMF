...
package UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin;
...
=head2 C<0..*> : C<pin> E<lt>---E<gt>  C<type> : UMMF::UML::MetaModel::Foundation::Core::Classifier C<0..1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin>.
...
=head2 C<isaBehavioral_Elements__Actions__Action_Foundation__Pin>


Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin>.
Other receivers will return false.
This is the fully qualified version of the C<isaPin> method.

=cut
sub isaBehavioral_Elements__Actions__Action_Foundation__Pin { 1 }
...
Returns the UML Model name (C<'Behavioral_Elements::Actions::Action_Foundation::Pin'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Behavioral_Elements::Actions::Action_Foundation::Pin' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin' =>
     {
       'table' => 'Behavioral_Elements__Actions__Action_Foundation__Pin',
       'abstract' => 1,
       'slots' => 
       { 
	 # Attributes
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin::___create(@args);
...
sub set_multiplicity ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::UML::MetaModel::Foundation::Data_Types::Multiplicity')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin.multiplicity");
  }
...
sub set_ordering ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::UML::MetaModel::Foundation::Data_Types::OrderingKind')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin.ordering");
  }
...
sub set_type ($$)
{
  ...
  if ( ($old = $self->{'type'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Foundation::Core::Classifier')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin.type") }
    ...
    $old->remove_pin($self) if $old;
    $val->add_pin($self)    if $val;
...
sub add_type ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'type'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Foundation::Core::Classifier')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin.type");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::Actions::Action_Foundation::Pin::type: too many")
    # if defined $self->{'type'};
