...
package UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction;
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction>.
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction::___create(@args);
...
sub set_signal ($$)
{
  ...
  if ( ($old = $self->{'signal'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction.signal") }
...
sub add_signal ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'signal'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Behavioral_Elements::Common_Behavior::Signal')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction.signal");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction::signal: too many")
    # if defined $self->{'signal'};
