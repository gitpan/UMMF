...
package UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction;
...
=head2 C<0..*> : C<> ----E<gt>  C<attribute> : UMMF::UML::MetaModel::Foundation::Core::Attribute C<1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction')  ;
}


=head2 C<__typecheck>

  UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaAttributeAction>


Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction>.
Other receivers will return false.

=cut
sub isaAttributeAction { 1 }


=head2 C<isaBehavioral_Elements__Actions__Read_Write_Actions__Attribute_Actions__AttributeAction>


Returns true if receiver is a L<UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction|UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction>.
Other receivers will return false.
This is the fully qualified version of the C<isaAttributeAction> method.

=cut
sub isaBehavioral_Elements__Actions__Read_Write_Actions__Attribute_Actions__AttributeAction { 1 }
...
Returns the UML Model name (C<'Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction' =>
     {
       'table' => 'Behavioral_Elements__Actions__Read_Write_Actions__Attribute_Actions__AttributeAction',
       'abstract' => 1,
       'slots' => 
       { 
	 # Attributes
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction::___create(@args);
...
sub set_attribute ($$)
{
  ...
  if ( ($old = $self->{'attribute'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML::MetaModel::Foundation::Core::Attribute')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction.attribute") }
...
sub add_attribute ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'attribute'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML::MetaModel::Foundation::Core::Attribute')->__typecheck($val, "UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction.attribute");
      
    # confess("UMMF::UML::MetaModel::Behavioral_Elements::Actions::Read_Write_Actions::Attribute_Actions::AttributeAction::attribute: too many")
    # if defined $self->{'attribute'};
